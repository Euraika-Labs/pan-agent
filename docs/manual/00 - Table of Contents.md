...
This is the full reading order for the Pan-Agent manual.
Read it user-first: Pan-Agent is a single-binary AI desktop agent with full PC control across Windows, macOS, and Linux.
