...
```json
{
  ...
  "pub_date": "2026-04-13T22:30:00Z",
  "platforms": {
    "windows-x86_64": {
      "signature": "untrusted comment: signature from minisign secret key\nRWQ...base64...",
      "url": "https://github.com/Euraika-Labs/pan-agent/releases/download/v0.2.0/Pan.Desktop_0.2.0_x64-setup.nsis.zip"
    },
    "darwin-aarch64": {
      "signature": "...",
      "url": "https://github.com/.../Pan.Desktop_0.2.0_aarch64.app.tar.gz"
    },
    "linux-x86_64": {
      "signature": "...",
      "url": "https://github.com/.../pan-desktop_0.2.0_amd64.AppImage.tar.gz"
    }
  }
}
```
...
Currently the Settings screen has a "Check for Updates" button that calls `POST /v1/config/update` (a backend stub returning `{available: false, current: "0.2.0"}`).
